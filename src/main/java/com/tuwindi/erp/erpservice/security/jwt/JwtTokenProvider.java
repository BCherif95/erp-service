...
import com.tuwindi.erp.erpservice.security.CustomUserDetailsService;
import com.tuwindi.erp.erpservice.security.SecurityConstants;
...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new CustomException("Jeton JWT expiré ou invalide", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
